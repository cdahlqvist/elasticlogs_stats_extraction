...
# Write all statistics to files in format <count>:<JSON object>
write_to_file(clientips, "clientips.jsl")
write_to_file(agents, "agents.jsl")
write_to_file(requests, "requests.jsl")
write_to_file(referrers, "referrers.jsl")
